...
def build_data():
    ...
    #使用mysql提供数据
    con = pymysql.connect(host="127.0.0.1",user="root",password="123456",db="pydata")
...
def deal_data(air_data):
    ...
    #LRMFC构建
    air_data = air_data.loc[:,['FFP_DATE','LOAD_TIME','LAST_TO_END','avg_discount','FLIGHT_COUNT','SEG_KM_SUM']]
